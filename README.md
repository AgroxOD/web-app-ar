...
Страница `cp.html` служит минимальной CMS для загрузки и редактирования моделей.
...
- Если установлена версия Node.js 22, возможно появление ошибок зависимостей. Используй Node.js 20 LTS.
