...
- **Node.js**: 18–21 (используй `nvm use 20`; Node.js 22 не поддерживается)
- **pnpm**: 9.x или новее
...
- При использовании Node.js 22 возможно возникновение проблем с зависимостями. Рекомендуется устанавливать Node.js 20 LTS.
